    ...
    <div className="bg-gray-900 min-h-screen text-white">
      ...
      <section className="py-16 bg-gray-900 relative overflow-hidden">
        ...
        <div className="absolute -left-3 top-1/3 hidden lg:block">
          <div className="h-8 w-12 bg-cyan-500 rounded-r-full flex items-center">
            <div className="h-3 w-3 bg-gray-900 rounded-full ml-1"></div>
          </div>
          <div className="absolute top-4 left-8 h-1 w-16 bg-cyan-300 transform -rotate-3"></div>
        </div>
      ...
      <section className="py-16 text-center relative overflow-hidden">
        ...
        {/* Bullet decorations */}
        <div className="absolute -right-10 top-1/4 hidden lg:block z-10">
          <div className="w-20 h-10 bg-cyan-500 rounded-l-full relative">
            <div className="absolute left-3 top-3 w-4 h-4 bg-gray-900 rounded-full"></div>
            <div className="absolute top-5 left-12 h-1 w-32 bg-cyan-300 transform rotate-6"></div>
          </div>
        </div>
        <div className="absolute -left-10 bottom-1/4 hidden lg:block z-10">
          <div className="w-20 h-10 bg-cyan-500 rounded-r-full relative">
            <div className="absolute right-3 top-3 w-4 h-4 bg-gray-900 rounded-full"></div>
            <div className="absolute top-5 right-12 h-1 w-32 bg-cyan-300 transform -rotate-6"></div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              {/* Logo with bullet for footer */}
              <div className="h-6 w-8 bg-cyan-500 rounded-r-full flex items-center justify-center mr-2">
                <div className="h-2 w-2 bg-gray-900 rounded-full ml-0.5"></div>
              </div>
              <span className="text-white font-bold">LUKAO<span className="text-cyan-400">.TV</span></span>
            </div>
            
            <div className="flex mb-4 md:mb-0 space-x-4">
              <a href="https://lukao.tv/live" className="text-gray-400 hover:text-cyan-500">
              ...
              <a href="https://twitter.com/lukao" className="text-gray-400 hover:text-cyan-500">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://instagram.com/lukao" className="text-gray-400 hover:text-cyan-500">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
